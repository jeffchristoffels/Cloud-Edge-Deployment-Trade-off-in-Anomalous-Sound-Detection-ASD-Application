...
print("Remote spectrogram inference speed test for baseline mobilenetv2")

def run_remote_analysis(remote_ip, username, private_key_path, data, machine_type, section_name):
    ssh_command = [
        "ssh",
        "-i",
        private_key_path,
...
for machine_type in machine_types:      # Test all machine types
    ...
    for audio_file in filenames:
        ...
        run_remote_analysis(remote_ip, username, private_key_path, data, machine_type, section_name)
