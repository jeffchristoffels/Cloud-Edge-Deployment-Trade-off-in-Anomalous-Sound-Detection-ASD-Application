...
if __name__ == "__main__":
    ...
    for idx, target_dir in enumerate(dirs):
        ...
        print("============== MODEL LOAD ==============")
        # load model file
        model_file = "{model}/model_{machine_type}.tflite".format(model=param["model_directory"],
        ...
        interpreter.resize_tensor_input(0, [309, 640])
        ...
        for dir_name in dir_names:
            ...
            for section_name in section_names:
                ...
                for file_idx, file_path in tqdm(enumerate(files), total=len(files)):
                    ...
                    y_pred[file_idx] = np.mean(np.square(data - output_data))
